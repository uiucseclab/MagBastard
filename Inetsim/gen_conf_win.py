...
def interface(offset, configFileName): 
	...
	print srvToRun
	print "\n\n"
	ftpBannersFile   = "ftp-banners-win.txt"
	smtpBannersFile  = "smtp-banners-win.txt"
	pop3BannersFile  = "pop3-banners-win.txt"
	httpBannersFile  = "http-banners-win.txt"
	httpsBannersFile = "http-banners-win.txt"
