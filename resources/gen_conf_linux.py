...
def interface(offset, configFileName): 
	...
	print srvToRun
	print "\n\n"
	ftpBannersFile   = "ftp-banners-linux.txt"
	smtpBannersFile  = "smtp-banners-linux.txt"
	pop3BannersFile  = "pop3-banners-linux.txt"
	httpBannersFile  = "http-banners-linux.txt"
	httpsBannersFile = "http-banners-linux.txt"
